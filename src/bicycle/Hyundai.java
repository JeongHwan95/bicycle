...
public class Hyundai implements Company{

	@Override
	public void orderBicycleParts(Person person) {
		System.out.println("Hyundai::orderBicycleParts(Person) invoked");
	...
	BrakeLever orderBrakeLever(int v1, int v2, int v3) {
		System.out.println("Hyundai::orderBrakeLever(v1, v2, v3) invoked");
	...
	public Gear orderGear(int v1, int v2, int v3) {		
		System.out.println("Hyundai::orderGear(v1, v2, v3) invoked");
	...
	public Handle orderHandle(int v1, int v2, int v3) {
		System.out.println("Hyundai::orderHandle(v1, v2, v3) invoked");
	...
	public Pedal orderPedal(int v1, int v2, int v3) {
		System.out.println("Hyundai::orderPedal(v1, v2, v3) invoked");
	...
	public Saddle orderSaddle(int v1, int v2, int v3) {
		System.out.println("Hyundai::orderSaddle(v1, v2, v3) invoked");
	...
	public WheelSet orderWheelSet(int v1, int v2, int v3) {
		System.out.println("Hyundai::orderWheelSet(v1, v2, v3) invoked");
